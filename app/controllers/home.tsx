...
const PROGRAMS: Program[] = [
  { id: 'mix', label: 'Mix 30°', durations: { normal: 115, rapid: 60, green: 130 } },
  { id: 'white', label: 'White 30°', durations: { normal: 105, rapid: 60, green: 120 } },
]

// 10m, 30m, then 1h–24h every 30m
const DELAY_SLOTS_MIN: number[] = [10, 30, ...Array.from({ length: 47 }, (_, i) => 60 + i * 30)]
...
function TimerPage() {
  return () => (
    <Document title="Washmachine Timer">
